...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case nint:
            return QString("tNTC");
        case mECA:
            return QString("mtNTC");
        case uECA:
            return QString::fromUtf8("μtNTC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case nint:
            return QString("NTC");
        case mECA:
            return QString("Milli-NTC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-NTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case nint:
            return QString("TestNTC");
        case mECA:
            return QString("Milli-TestNTC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestNTC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
