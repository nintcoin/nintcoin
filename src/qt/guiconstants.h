...
/* nint GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "nint"
#define QAPP_ORG_DOMAIN "nintproject.org"
#define QAPP_APP_NAME_DEFAULT "nint-Qt"
#define QAPP_APP_NAME_TESTNET "nint-Qt-testnet"
