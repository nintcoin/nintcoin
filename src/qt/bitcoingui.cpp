                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nint Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&nint Project"), this);
    webmainAction->setStatusTip(tr("nint Project Website"));
    ...
    facebookAction->setStatusTip(tr("nint Facebook"));
    ...
    twitterAction->setStatusTip(tr("nint Twitter"));
    ...
    discordAction->setStatusTip(tr("nint Discord"));
    ...
    youtubeAction->setStatusTip(tr("nint Youtube"));
    ...
    telegramAction->setStatusTip(tr("nint Telegram"));
    ...
    redditAction->setStatusTip(tr("nint Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap nint"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell nint Coin (nint)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    nintBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&nint block explorer"), this);
    nintBlockExplorerAction->setStatusTip(tr("nint blockchain explorer"));
    nintBlockExplorerAction->setToolTip(nintBlockExplorerAction->statusTip());
    nintBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&nint Project Github"), this);
    githubAction->setStatusTip(tr("nint Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a nint address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nint: URIs)"));
...
//    }
    ...
    connect(nintBlockExplorerAction, SIGNAL(triggered()), this, SLOT(nintBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About nint Core"), this);
    aboutAction->setStatusTip(tr("Show information about nint Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for nint"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nint addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nint addresses"));
    ...
    openAction->setStatusTip(tr("Open a nint: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the nint Core help message to get a list with possible nint command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(nintBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("nint Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.nint.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/nint.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/nint4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/nintcryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/nint-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::nintBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/nint/nint/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nint network", "", count));
}
...
{
    QString strTitle = tr("nint Core"); // default title
