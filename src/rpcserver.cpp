...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* nint features */
        {"nint", "masternode", &masternode, true, true, false},
        {"nint", "listmasternodes", &listmasternodes, true, true, false},
        {"nint", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nint", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nint", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"nint", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"nint", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"nint", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nint", "masternodedebug", &masternodedebug, true, true, false},
        {"nint", "startmasternode", &startmasternode, true, true, false},
        {"nint", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nint", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nint", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nint", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nint", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nint", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nint", "mnbudget", &mnbudget, true, true, false},
        {"nint", "preparebudget", &preparebudget, true, true, false},
        {"nint", "submitbudget", &submitbudget, true, true, false},
        {"nint", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nint", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nint", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nint", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nint", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nint", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nint", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nint", "checkbudgets", &checkbudgets, true, true, false},
        {"nint", "mnsync", &mnsync, true, true, false},
        {"nint", "spork", &spork, true, true, false},
        {"nint", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> nint-cli " + methodname + " " + args + "\n";
}
