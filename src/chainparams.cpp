...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "nint is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1622160997;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 5238637;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x970f5a6fa320c638dc7f25db695748344241db08c1f940376c52f62d4cbc40cf"));
        assert(hashGenesisBlock == uint256("0x00000064ca12ed6af56d140a6e22db0c207e59afa1df40d727003b9bd2a3b06f"));

     
		
	vSeeds.push_back(CDNSSeedData("207.148.6.87","207.148.6.87"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x970f5a6fa320c638dc7f25db695748344241db08c1f940376c52f62d4cbc40cf"));
        assert(hashGenesisBlock == uint256("0x0000222b774032c61d97a57a88f6ce9bf671d29509bb2d0f26623f701068f909"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x970f5a6fa320c638dc7f25db695748344241db08c1f940376c52f62d4cbc40cf"));
        assert(hashGenesisBlock == uint256("0x5ada674d42ca7293eb40ed5b5aef4eb11c66a2d874a2c3f5bbdff9a3ab00b4bc"));
