Contributing to nint Core
============================

The nint Core project operates an open contributor model where anyone is
...
The following applies to code changes to the nint Core project, and is not to be
confused with overall nint Network Protocol consensus changes.

Whether a pull request is merged into nint Core rests with the project merge
...
Patches that change nint consensus rules are considerably more involved than
...
Where a patch set proposes to change the nint consensus, it must have been
...
The project leader is the release manager for each nint Core release.
