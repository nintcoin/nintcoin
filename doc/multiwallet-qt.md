...
In order to support loading of multiple wallets in nint-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nint.cpp.
...
Changes to nint.cpp
----------------------
nint.cpp is the entry point into nint-qt, and as such, will require some minor modifications to provide hooks for
