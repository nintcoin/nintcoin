...
RESOURCES += src/qt/nint.qrc src/qt/nint_locale.qrc

TRANSLATIONS += src/qt/locale/nint_bg.ts \
                src/qt/locale/nint_de.ts \
                src/qt/locale/nint_en.ts \
                src/qt/locale/nint_es.ts \
                src/qt/locale/nint_fi.ts \
                src/qt/locale/nint_fr.ts \
                src/qt/locale/nint_it.ts \
                src/qt/locale/nint_ja.ts \
                src/qt/locale/nint_pl.ts \
                src/qt/locale/nint_pt.ts \
                src/qt/locale/nint_ru.ts \
                src/qt/locale/nint_sk.ts \
                src/qt/locale/nint_sv.ts \
                src/qt/locale/nint_vi.ts \
                src/qt/locale/nint_zh_CN.ts \
                src/qt/locale/nint_zh_TW.ts
